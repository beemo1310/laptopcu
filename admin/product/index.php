...
<body>
    ...
    <div class="container">
        ...
        <p><strong>Bấm vào phần tiêu đề để sắp xếp bảng</strong></p>
        <p>Bấm lần đầu, bảng sẽ được sắp xếp từ A đến Z.</p>
        <p>Bấm lần hai, bảng sắp xếp theo hướng ngược lại.</p>
    </div>
