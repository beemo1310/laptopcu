...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><img height="20px" width="20px" src="./avatar.png" alt=""><?php echo 'Xin Chào!  ' . $_SESSION['user_login'] ?></li>
                            ...
                            <li><a href="checkout.php"><i class="fa fa-check"></i> Thông tin</a></li>
    ...
    <div class="site-branding-area" style="background-color:#243a76;">
        <div class="container">
            <div class="row" >
                <div class="col-sm-6" >
                    <div class="logo">
